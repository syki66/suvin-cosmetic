                ...
                <MDBRow className="font-small">
                    <MDBCol className="py-2" size="12" lg="9">
                        <div>
                            ...
                            <div className="footer_display">통신판매업신고번호 : 제2019-경기부천-1661호</div>
                        </div>
                        <div>
                            <div className="footer_display">상호 : 수빈코스메틱&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                            <div className="footer_display">대표 : 김덕훈</div>
                        </div>
                        <div>
                            <div className="footer_display">주소 : [14566] 경기도 부천시 부천로 136번길 27 원미어울마당 406호</div>
                        </div>
                        <div>
                            <div className="footer_display">Tel : 1688-9028&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                            <div className="footer_display">Mobile : 010-6644-3665&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                    ...
                    <MDBCol size="12" lg="3" className="py-3 py-lg-2 footer-lg-right" style={{display:"flex", justifyContent:"center", alignItems:"center"}}>
                        ...
                        <a className="px-5 px-lg-1" href="mailto:suvin@suvincos.com" title="click to E-mail"><img src={emailIcon_32} /></a>
                        <a className="pl-5 px-lg-1" href="https://www.youtube.com/channel/UCPV-UvOZJU92ZfEv0LR3uvg" title="click to youtube"><img src={youtubeIcon_32} /></a>
                    </MDBCol>
                </MDBRow>
            </MDBContainer>
