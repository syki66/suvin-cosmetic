...
/*
    ...
    가로선그은거 창벌리면 미세하게 오른쪽 달라지는거 해결하기
 */
                    ...
                    <MDBRow className="">
                        ...
                        <MDBCol size="12" className="">
                            ...
                            <div style={{position:"relative", zIndex:"1"}}>
                                ...
                                <ul className="py-4" style={{ backgroundColor: "transparent" }}>
                    ...
                    <MDBRow className="pb-5">
                        <MDBCol size="12" className="">
                            ...
                            <div style={{position:"relative", zIndex:"1"}}>
                                    ...
                                    <div style={{flex:"1", backgroundColor:"transparent"}}></div>
                                        ...
                                        <div style={{flex:"1", display:"flex"}}>
                                            <div style={{
                                                ...
                                                borderRight: "848px solid #f4f4f4",
                                                borderTop: "88px solid transparent",

                                                width:"0px",
                                                height:"0px"
                                                }}></div>
                                        </div>
                                        <div style={{flex:"1", backgroundColor:"#f4f4f4"}}></div>
                                ...
                                <div>
                                    <div>
                                        Founded on the base of the patented technology about pore care by President Kim Duckhoon, a 30-year cosmetic R&D 
                                        specialist, Suvin has presently a wide and competitive product line, global network and diverse<br /> distribution
                                        Channel. Future development and prosperity is expected with<br /> faithful customers
                                        and product reputation on market.
                                    </div>
                                    <div className="px-4 py-4 border border-light py-xl-5 after_appear_cssShapeBox" style={{backgroundColor:"#f4f4f4"}}>
                                        모공관리 특허기술을 기반으로 설립한<br />
                                        수빈코스메틱은 경쟁력 있는 다양한 제품들을 여러 판매망를 통하여<br />
